...
𓊪 𛄅⵿۫۫〬🌴𔗄 𝖭𝗈𝗆𝖻𝗋𝖾 : %name
𓊪 𛄅⵿۫۫〬🌴𔗄 𝖬𝗈𝖽𝗈 : publico
𓊪 𛄅⵿۫۫〬🌱𔗄 𝖱𝗎𝗇 : [%uptime]
𓊪 𛄅⵿۫۫〬🌾𔗄 𝖮𝗐𝗇𝖾𝗋 : @${ownerMention}
𓊪 𛄅⵿۫۫〬🌷𔗄 𝖯𝗋𝖾𝖿𝗂𝗑 : ( ! . / )
𓊪 𛄅⵿۫۫〬🌿𔗄 𝖢𝗈𝗆𝖺𝗇𝖽𝗈𝗌 : %totalf
𓊪 𛄅⵿۫۫〬🎍𔗄 𝖵𝖾𝗋𝗌𝗂𝗈𝗇 : 1.0.0-beta
%readmore`.trimStart(),
  header: '\n%category',
  body: '°𓃉𐇽ܳ𓏸%emojiᮬᩬִּ〫᪲۟. %cmd %islimit %isPremium',
  footer: '',
  after: '\n> 𝖯𝗈𝗐𝖾𝗋 𝖡𝗒 𝖨𝗓𝗎𝗆𝗂 - 𝖬𝖺𝗈 𝖢𝗁𝖺𝗇 𝖠𝗌𝗌𝗂𝗌𝗍𝖺𝗇𝗍',
}
